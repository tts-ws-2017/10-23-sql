...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post weathers_url, params: { weather: { intensity: @weather.intensity, name: @weather.name, scary: @weather.scary } }
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { intensity: @weather.intensity, name: @weather.name, scary: @weather.scary } }
