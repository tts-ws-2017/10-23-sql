...
class FlowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flower" do
    assert_difference('Flower.count') do
      post flowers_url, params: { flower: { height: @flower.height, name: @flower.name, pretty: @flower.pretty, smell: @flower.smell } }
    end
  ...
  test "should update flower" do
    patch flower_url(@flower), params: { flower: { height: @flower.height, name: @flower.name, pretty: @flower.pretty, smell: @flower.smell } }
